...
// function printInfo(){
//     return `${this.name} and class is ${this.class}`
// }
// const info = {
//     name : 'Raja',
//     class : 'Third Year',
...
//     getclass : function(){return `${this.classe}`},
//     getmarks : function(){return `${this.marks}`}  
// }

// function getInfo(name , classe , marks){
//     const object = Object.create(funList)
//     object.name  = name
//     object.class = classe
//     object.marks = marks
//     object.getname = funList.getname.call(object)
//     return object
// }
// const userobj = getInfo('Rohit', 'Mathemetics', 100)
// console.log(userobj)
// console.log(userobj.getmarks())

// Output Way 

 
function getInfo(name , classe , marks){
    const object = Object.create(getInfo.prototype.funList1)
    object.name  = name
    object.class = classe
    object.marks = marks
    // object.getname = getInfo.prototype.getname.call(object)
    return object
}
getInfo.prototype.funList1 =  
{
    getname : function(){return `${this.name}`},
    getclass : function(){return `${this.classe}`},
    getmarks : function(){return `${this.marks}`}  
}
const newobj = getInfo('Rohit', 'Mathemetics', 100)
